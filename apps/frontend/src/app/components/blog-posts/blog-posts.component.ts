...
export class BlogPostsComponent {
  ...
  blogPosts: BlogPost[] = [
    {
      title: "Lightweight code coverage quality gate",
      link: "https://medium.com/@darbj95/lightweight-code-coverage-quality-gate-bc595d18bf1",
      content: "",
    },
  ];
  blogs: MarkdownBlog[] = [
    {
      title: "The power of unit testing",
      path: "/markdown-files/blog-posts/power-of-unit-testing.md",
    },
    {
      title: "Enhancing DevOps with GitOps",
      path: "/markdown-files/blog-posts/enchancing-devops-with-gitops.md",
    },
    {
      title: "The Unwritten Rules 📜",
      path: "/markdown-files/blog-posts/the-unwritten-code.md",
    },
  ];
  ...
  constructor(
    ...
    for (let markdownBlog of this.blogs) {
      this.http
        .get(markdownBlog.path, { responseType: "text" })
        .subscribe((data) => {
